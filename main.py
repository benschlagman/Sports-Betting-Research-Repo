...
def run(s3: S3, mongodb: MongoDB, grid_fs: GridFs, file_key: str, market_filter: MarketFilters, meta_builder: MetaBuilder, country_filter: CountryFilters):
    ...
    result_ladders = mongodb.insert_many(
        Collections.Ladders, ladders, result_meta, type="ts")
    result_ts_marketdata = mongodb.insert_many(
        Collections.Marketdata, ts_marketdata, result_meta, type="ts")
